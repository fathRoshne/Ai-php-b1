  ...
  <body >
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      ...
      <div class="container-md text-center mt-5" style="max-width: 700px;">
        <div class="mb-4 hero-text">Task App</div>
            ...
            <tbody>
                ...
                if ($conn->connect_error) {
                  ...
                  if(isset($_GET['search'])){
                    ...
                    $sql = "SELECT id, createdDate,listName,caption FROM task WHERE email = '$email' AND createdName LIKE '%$search%' ORDER BY createdDate DESC";
                }else{
